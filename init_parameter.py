...
def init_model():
    ...
    parser.add_argument("--freeze_bert_parameters_pretrain", action="store_true", help="Freeze the last parameters of BERT.")

    parser.add_argument("--freeze_bert_parameters_em", action="store_true", help="Freeze the last parameters of BERT.")

    parser.add_argument("--save_model_pre", action="store_true", help="Save trained model.")

    parser.add_argument("--load_clinc_pretrain", action="store_true", help="load_clinc_pretrain.")

    parser.add_argument("--save_model", action="store_true", help="Save trained model.")

    parser.add_argument("--clinc_pretrain", action="store_true", help="Clinc pretrain")
    parser.add_argument("--augment_data", action="store_true", help="Clinc pretrain")
    parser.add_argument("--augment_data_2", action="store_true", help="Clinc pretrain")
    parser.add_argument("--pretrain", action="store_true", help="Pre-train the model with labeled data.")

    parser.add_argument("--pseudo_label", action="store_true", help="是否加上伪标签loss")
    ...
    parser.add_argument('--k', type=int, default=1, help="Random seed for initialization.")
    ...
    parser.add_argument("--gpu_id", type=str, default='5', help="Select the GPU id.")
    ...
    parser.add_argument("--lr_ft", default=5e-5, type=float,
                        help="The learning rate for pre-training.")
    ...
    parser.add_argument("--subclincdata", action="store_true", help="Usesubclincdata")
